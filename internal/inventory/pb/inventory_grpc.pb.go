...
type InventoryGrpcServiceClient interface {
	Search(ctx context.Context, in *SearchReq, opts ...grpc.CallOption) (*InventoryResponse, error)
}
...
type InventoryGrpcServiceServer interface {
	Search(context.Context, *SearchReq) (*InventoryResponse, error)
...
func (UnimplementedInventoryGrpcServiceServer) Search(context.Context, *SearchReq) (*InventoryResponse, error) {
...
func _InventoryGrpcService_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryGrpcServiceServer).Search(ctx, in)
	}
...
var InventoryGrpcService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Search",
			Handler:    _InventoryGrpcService_Search_Handler,
		},
	},
